#!/usr/bin/env bash
#SBATCH --job-name=probeEEV_P40
#SBATCH --account=def-tms_cpu
#SBATCH --time=01:30:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --output=/scratch/atorre/probeEEV_P40_%j.out
#SBATCH --error=/scratch/atorre/probeEEV_P40_%j.err
set -uo pipefail
cd /home/atorre/UTSP/unione/git/UTSP/common && source env.sh
export TESI_EXPERIMENT=PERT TESI_N_NODES=40
export TESI_STO_TIME_LIMIT=3600 TESI_STO_MIP_GAP=0.01   # cap EEV+STO a 1h/gap1%
export TESI_TEST_SKIP_PI=1
export TESI_OUTPUT_OVERRIDE=/scratch/atorre/probeEEV_P40
export TESI_CACHE_DIR_OVERRIDE=/scratch/atorre/probeEEV_P40/pkl
