...
N_TEST_SCENARIOS = _env_int(
    ...
    min(DIM_ISTANZA_TEST * N_ISTANZE_TEST, N_WIND_OBSERVATIONS_TEST),
)
...
DROP_LAST_TEST_BATCH = _env_bool("TESI_DROP_LAST_TEST_BATCH", True)
...
UTSP2_LAMBDA_B_DIV = _env_float("TESI_UTSP2_LAMBDA_B_DIV", 1.0)   # lambda_B = |Omega| / divisore
